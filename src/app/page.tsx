  ...
  return (
    <main className="h-screen w-screen bg-[#050608] text-slate-300 font-sans p-4 flex flex-col overflow-hidden">
      ...
      <header className="flex-none flex items-center justify-between pb-4">
        ...
        <div className="flex items-center gap-3">
            <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[#0a0c10] border border-slate-800 text-xs text-slate-400 hover:text-white hover:border-slate-600 transition-all">
            ...
            <button className="p-2.5 text-slate-500 hover:text-white transition-all hover:bg-[#0a0c10] rounded-xl"><Settings className="w-4 h-4" /></button>
            <button className="p-2.5 text-slate-500 hover:text-white transition-all hover:bg-[#0a0c10] rounded-xl"><HelpCircle className="w-4 h-4" /></button>
        </div>
      </header>
