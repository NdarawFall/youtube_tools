...
import { Video, LayoutGrid, Settings, HelpCircle, Type, User } from 'lucide-react';

const TOOLS = [
  { id: 'frame-extractor', name: 'Frame Extractor', icon: Video, description: 'Extraction d\'images HD' },
  { id: 'char-counter', name: 'Compteur Texte', icon: Type, description: 'Statistiques de script' },
];
    ...
    <main className="h-screen w-screen bg-[#050608] text-slate-300 font-sans p-4 flex flex-col overflow-hidden">
      ...
      <header className="flex-none flex items-center justify-between pb-4">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-[#0a0c10] border border-slate-800 flex items-center justify-center text-slate-400">
